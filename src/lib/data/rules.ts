...
const rule3: Rule = {
	...
	contentPL:
		'Użytkownicy często wykonują czynności przez pomyłkę. Potrzebują wyraźnie oznaczonego „wyjścia awaryjnego”, aby opuścić niepożądaną czynność bez konieczności przechodzenia przez długotrwały proces.',
