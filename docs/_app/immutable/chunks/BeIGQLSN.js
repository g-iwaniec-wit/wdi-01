...
import { b as Fe } from './DRvfUcEA.js';
function ke(s) {
	let e = 0,
		r = J(0),
		i;
...
class xe {
		...
		e &&
			...
			N(() => {
				var r = (this.#a = document.createDocumentFragment()),
					i = K();
				(r.append(i),
					(this.#n = this.#p(() => (k.ensure(), p(() => this.#o(i))))),
					this.#h === 0 &&
						(this.#t.before(r),
						(this.#a = null),
						I(this.#r, () => {
	...
	#u() {
		this.is_pending = !1;
		for (const e of this.#c) ($(e, fe), q(e));
		for (const e of this.#_) ($(e, he), q(e));
	...
	#p(e) {
		var r = b,
			i = Q,
			f = X;
		(D(this.#e), A(this.#e), L(this.#e.ctx));
		try {
			return e();
		} catch (t) {
			return (le(t), null);
	...
	error(e) {
		...
		N(() => {
			...
			a !== null && typeof a == 'object' && typeof a.then == 'function'
				? a.then(c, (h) => T(h, this.#e && this.#e.parent))
				: c(a);
		});
	}
}
...
function z(s) {
	...
	if (((t = f[n] || s.target), t !== e)) {
		...
		try {
			for (var u, l = []; t !== null; ) {
				var o = t.assignedSlot || t.parentNode || t.host || null;
				try {
					var d = t[S]?.[i];
				...
				if (s.cancelBubble || o === e || o === null) break;
				t = o;
			}
			if (u) {
				for (let _ of l)
			...
			((s[S] = e), delete s.currentTarget, A(y), D(E));
		}
	}
}
function $e(s, e) {
...
function qe(s, e) {
	...
	const r = e.target,
		...
		f = g;
	try {
		for (var t = me(r); t && (t.nodeType !== Z || t.data !== be); ) t = Ee(t);
		if (!t) throw M;
		(w(!0), O(t));
		const n = G(s, { ...e, anchor: t });
		return (w(!1), n);
	} catch (n) {
		if (
			n instanceof Error &&
			...
			Ye(
				...
				(l) => {
					...
					if (
						...
						v && Fe(l, null),
						(a = s(l, i) || {}),
						v && ((b.nodes.end = g), g === null || g.nodeType !== Z || g.data !== De))
					)
						throw (Ae(), M);
					Oe();
				},
					...
					for (var o = 0; o < l.length; o++) {
						...
						if (!E.has(d)) {
							...
							for (const F of [e, document]) {
								...
								var P = m.get(d);
								P === void 0
									? (F.addEventListener(d, z, { passive: _ }), m.set(d, 1))
									: m.set(d, P + 1);
							}
						}
					}
					...
					for (var l of E)
						for (const _ of [e, document]) {
							var o = R.get(_),
								d = o.get(l);
							--d == 0
								? (_.removeEventListener(l, z), o.delete(l), o.size === 0 && R.delete(_))
								: o.set(l, d);
						}
...
export { qe as h, Ve as m, $e as s, Le as u };
